...
icon = Image.open("https://github.com/balamurukansu/Airbnb-Analysis/blob/main/image/airbnb_logo.png")
...
with st.sidebar:
    st.image('https://github.com/balamurukansu/Airbnb-Analysis/blob/main/image/airbnb_banner.jpg')
